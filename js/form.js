...
document.writeln("<tr>");
document.writeln("<td><!-- Text input-->");
document.writeln("<label class=\"control-label\" for=\"name\">Your Name:<span class=\"red\">*</span></label></td>");
...
document.writeln("<tr>");
document.writeln("<td><!-- Text input-->");
document.writeln("<label class=\"control-label\" for=\"input01\">Your Email:<span class=\"red\">*</span></label></td>");
...
document.writeln("<tr>");
document.writeln("<td><!-- Text input-->");
document.writeln("<label class=\"control-label\" for=\"phone\">Your telephone:</label></td>");
...
document.writeln("</tr>");
document.writeln("<tr>");
document.writeln("<td colspan=\"2\"  valign=\"top\"><!-- Textarea -->");
document.writeln("<labelclass=\"control-label\">Detailed requirements:<span class=\"red\">*</span></label>");
...
document.writeln("<p class=\"submit\" ><input  type=\"submit\" value=\"Save\" class=\"btn btn-primary\" /></p>");
document.writeln("<p class=\"submit\" ><input  type=\"submit\" value=\"Send Messages\" class=\"btn btn-primary\" /></p>");
